...
Такая ситуация может привести к классической проблеме переобучения, когда модель слишком уж хорошо затачивается под обучающий сет, но не обладает достаточной обобщающей способностью, чтобы хорошо классифицировать новые данные, то есть те, которые модель не видела при обучении.
